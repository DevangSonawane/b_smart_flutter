...
class _GiftCoinsScreenState extends State<GiftCoinsScreen> {
  ...
  void _loadUsers() {
    // Get list of users to gift (excluding current user)
    setState(() {
  ...
  Future<void> _sendGift() async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Send $amount coins to ${_selectedUser!.name}?',
        ),
        actions: [
          TextButton(
      ...
      if (success) {
        ...
        _notificationService.addNotification(
          NotificationItem(
            ...
            title: 'Gift Sent',
            message: 'You sent $amount coins to ${_selectedUser!.name}',
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text('Successfully sent $amount coins to ${_selectedUser!.name}'),
